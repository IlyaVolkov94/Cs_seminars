...
BufArray = RandomArray(Size);   //Заполняем буферный массив рандомным массивом. Обратите внимание переменная Size в этой строчке и переменная Size в 18 срочке - разные переменные. Одна принадлежить основной программе, другая обозначает вход функции.
